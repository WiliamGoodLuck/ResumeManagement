            ...
            <div class="forms">
                ...
                <div class="panel-body widget-shadow" data-example-id="basic-forms">
                    <div class="form-body">
                        ...
                        <form action="${pageContext.request.contextPath}/personnel/manager/update.do" method="post" onsubmit="return check();"
                              name="update" >
                                <table align="center">
                                    <tr style="display:none"> <td>id:</td><td><input type="text" name="id" value="${personnel.id}"></td></tr>
                                    <tr><td>姓名:</td><td><input type="text" name="userName" id="userName"  value="${personnel.userName}"></td></tr>
                                    <tr> <td >性别:</td><td>
                                      <input type="radio" name="gender" value="1" ${personnel.gender=='1'?'checked':'' }/>男 &nbsp&nbsp&nbsp
                                        <input type="radio" name="gender" value="2" ${personnel.gender=='2'?'checked':'' }/>女
                                    </td></tr>
                                    <tr> <td>年龄:</td><td><select name="age" >
                                        <option>${personnel.age}</option>
                                        <c:forEach var="i" begin="18" end="50"><!--相当于for(i=6;i<=100;i++) -->
                                        <option value="${i }" >${i }</option><!--取i的值 -->
                                        </c:forEach></select></td></tr>
                                    <tr> <td>学历:</td><td><input type="text" name="education" value="${personnel.education}"></td></tr>
                                    <tr> <td>工作分类:</td><td><input type="text" name="workType" value="${personnel.workType}"></td></tr>
                                    <tr> <td>工作年限:</td><td><input type="text" name="serviceYear" value="${personnel.serviceYear}"></td></tr>
                                    <tr> <td>联系电话:</td><td><input type="text" name="phoneNumber" value="${personnel.phoneNumber}"></td></tr>
                                    <tr> <td>邮箱:</td><td><input type="text" name="email" value="${personnel.email}"></td></tr>
                                    <tr> <td>状态:</td><td>
                                        <input type="radio" name="status" value="1" ${personnel.status=='1'?'checked':'' }/>在职 &nbsp&nbsp&nbsp
                                        <input type="radio" name="status" value="2" ${personnel.status=='2'?'checked':'' }/>离职
                                    </td></tr>
