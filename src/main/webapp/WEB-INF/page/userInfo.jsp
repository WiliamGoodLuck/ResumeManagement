    ...
    <div id="page-wrapper">
        <div class="main-page">
            ...
            <div class="panel-body widget-shadow">
                <form action="${pageContext.request.contextPath }/user/system/page?userName=${pageInfo.nickName}" method="get" id="form1">

                    <span>姓名:</span><input type="text" name="nickName" maxlength="20" value="${pageInfo.nickName}"/>
            ...
            <div class="panel-body widget-shadow">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <c:forEach var="user" items="${pageInfo.userList}" varStatus="status">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="${pageContext.request.contextPath}/user/system/toUpdateRole.do?id=${user.id}">修改角色</a>

                                |

                                <a href="${pageContext.request.contextPath}/user/system/delete.do?id=${user.id}">删除</a>
                            </td>
                                <%-- <td>${user.age}</td>--%>
                        </tr>
                    </c:forEach>
                    ...
                    <div  id="pagin-btm" >
                        <p id="common_page">
                            ...
                            <a href="${pageContext.request.contextPath }/user/system/page?nickName=${pageInfo.nickName}&thisPage=${pageInfo.firstPage}&pageSize=${pageInfo.pageSize}">首页</a>
                            <a href="${pageContext.request.contextPath }/user/system/page?nickName=${pageInfo.nickName}&thisPage=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a>
                            ...
                            <c:forEach begin="${begin }" end="${end }" step="1" var="i">
                                ...
                                <c:if test="${pageInfo.thisPage != i }">
                                    <a href="${pageContext.request.contextPath }/user/system/page?nickName=${pageInfo.nickName}&thisPage=${i}&pageSize=${pageInfo.pageSize}">${i }</a>
                                </c:if>
                            </c:forEach>

                            <a href="${pageContext.request.contextPath }/user/system/page?nickName=${pageInfo.nickName}&thisPage=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a>
                            <a href="${pageContext.request.contextPath }/user/system/page?nickName=${pageInfo.nickName}&thisPage=${pageInfo.lastPage}&pageSize=${pageInfo.pageSize}">尾页</a>
